...
**Agents**: code-reviewer, security-auditor, accessibility-auditor, test-writer, architect, tech-writer, tdd-red, tdd-green, tdd-refactor, database-reviewer, acquire-codebase, agent-owasp, ai-team, prompt-safety, autoresearch, audit-fix, code-exemplars
